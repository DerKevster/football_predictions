...
def make_dataframe_row(home, away, matchday, merged_df, fifa_df, squad_value_df, past_matches = 5):

    dicto = {}
    dicto = {'home':home,
             'away':away,
             'matchday' : matchday,
             'shots_h' : ff.get_shots(home, matchday, merged_df, past_matches),
             'shots_ot_h' : ff.get_shots_ot(home, matchday, merged_df, past_matches),
             'goals_h' : ff.get_goals(home, matchday, merged_df, past_matches),
             'conc_h' : ff.get_conc(home, matchday, merged_df, past_matches),
             'corner_h' : ff.get_corners(home, matchday, merged_df, past_matches),
             'goaldiff_h' : ff.get_goal_diff(home, matchday, merged_df),
             'opp_avg_h' : ff.get_opp_avg(home, matchday, merged_df, past_matches),
             ...
             'shots_ot_a' : ff.get_shots_ot(away, matchday, merged_df, past_matches),
             'shots_a' : ff.get_shots(away, matchday, merged_df, past_matches),
             'goals_a' : ff.get_goals(away, matchday, merged_df, past_matches),
             'conc_a' : ff.get_conc(away, matchday, merged_df, past_matches),
             'corner_a' : ff.get_corners(away, matchday, merged_df, past_matches),
             'goaldiff_a' : ff.get_goal_diff(away, matchday, merged_df),
             'opp_avg_a' : ff.get_opp_avg(away, matchday, merged_df, past_matches),
